...
export async function POST(
  ...
  try {
    ...
    if (existing.isLocked) {
      return apiError('ALREADY_LOCKED', 'Academic year is already locked', requestId, undefined, 409);
    }
    ...
    return handleApiError(error, requestId, 'POST /api/v1/academic-years/[id]/lock');
  }
}
