...
export default function FacultyError({
  ...
  useEffect(() => {
    console.error('[FacultyPortal][ErrorBoundary]', error.digest ?? error.message);
  }, [error]);
    ...
    <div className="flex items-center justify-center p-6">
      <Card className="w-full max-w-lg border-slate-200 shadow-lg">
        <CardHeader>
          ...
          <CardDescription>
            This page hit an unexpected error. Try again or return to your classes.
          </CardDescription>
        </CardHeader>
        <CardContent>
          {error.digest && (
          ...
          <div className="mt-5 flex gap-3">
            ...
            <Button variant="outline" onClick={() => window.location.replace('/faculty')}>
              Back to classes
            </Button>
          </div>
        </CardContent>
