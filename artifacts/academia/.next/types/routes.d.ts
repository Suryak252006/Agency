...
interface ParamMap {
  ...
  "/api/v1/academic-years/[id]": { "id": string; }
  "/api/v1/academic-years/[id]/lock": { "id": string; }
  "/api/v1/academic-years/[id]/set-current": { "id": string; }
  "/api/v1/academic-years/[id]/terms": { "id": string; }
  "/api/v1/academic-years/[id]/terms/[termId]": { "id": string; "termId": string; }
  "/api/v1/audit-logs": {}
  "/api/v1/classes": {}
  ...
  "/api/v1/sections": {}
  "/api/v1/sections/[id]": { "id": string; }
  "/api/v1/subjects": {}
  "/api/v1/subjects/[id]": { "id": string; }
  "/auth/login": {}
  "/faculty": {}
  "/faculty/classes": {}
  "/faculty/requests": {}
